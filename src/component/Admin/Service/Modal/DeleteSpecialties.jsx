                                ...
                                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell align="center">Phòng khám</TableCell>
                                            <TableCell align="center">Giá khám</TableCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
                                        {dataSpecialties.bookings ?
                                            dataSpecialties.bookings.map((booking) => (
                                                <TableRow
                                                    key={booking.id}
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="center">{booking.clinic}</TableCell>
