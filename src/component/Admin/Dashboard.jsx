  ...
  return (
    <div className="flex flex-col w-full h-full py-10 px-16">
      ...
      <SpeedDial
        ...
        sx={{ position: "absolute", bottom: 600, right: 60 }}
        icon={
      ...
      <DoctorReport open={openDoctorReport} setOpen={setOpenDoctorReport} />
      <ClinicReport open={openClinicReport} setOpen={setOpenClinicReport} />
